...
saveHandler.saveEdits = function( datasource ) {
    ...
    var promise = soaSvc.postUnchecked( 'Internal-StructureManagement-2018-11-MassUpdate',
        'saveImpactedAssemblies', soaInput );

    promise.then( function( serviceData ) {
...
app.factory( 'massUpdateSaveHandler', () => exports );
