 ...
 */
export let getMeasurableAttrParentObjectTypes = function( data ) {
    ...
    prefSvc.getStringValues( [ PLE_MEASURABLEATTRPARENTOBJECTTYPES_PREFERENCE ] ).then( function( types ) {
        ...
        data.parentObjectTypes = measurementParentTypes;
 ...
 *
 * @memberof NgServices
 * @member attributeDefinitionTypesService
 */
app.factory( 'attributeDefinitionTypesService', () => exports );
