 ...
 * 
 * @module js/unselectLicenseCellCommandHandler
 */
import app from 'app';
...
export let execute = function( vmo ) {
    ...
    if( vmo && vmo.uid ) {
        ...
        eventBus.publish( "awp0Security.unselectLicense" );
    }
};
 ...
 * 
 */
export let unselectLicense = function( data ) {
    licenseMgmtService.addToAvailableLicenses( data, _selectedLicenses );
};
 ...
 */
app.factory( 'unselectLicenseCellCommandHandler', () => exports );
