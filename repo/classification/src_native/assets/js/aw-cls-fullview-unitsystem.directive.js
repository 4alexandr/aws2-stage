...
/**
 * @module js/aw-cls-fullview-unitsystem.directive
 */
import app from 'app';
 ...
 *
 * @example <aw-cls-fullview-unitsystem prop="data.unitSystem" action="convertValues"></aw-cls-unitsystem>
 *
 * @member aw-cls-fullview-unitsystem
 * @memberof NgElementDirectives
 */
app
    .directive(
        'awClsFullviewUnitsystem',
        [
            'viewModelService',
