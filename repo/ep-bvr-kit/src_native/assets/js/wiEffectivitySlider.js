...
/**
 *
 * @module js/wiEffectivitySlider
 */
import effectivitySliderHandler from 'js/wiEffectivitySliderHandler';
...
var EffectivitySlider = function( configuration ) {
...
export let setEffectivitySliderConfiguration = function( configuration ) {
    var effectivitySlider = new EffectivitySlider( configuration );
    return effectivitySlider;
};

EffectivitySlider.prototype.drawUnitEffectivitySliders = function() {
    var sliderContainer = this.container;
    var leftSliderElement = createSliderElement();
    sliderContainer.appendChild( leftSliderElement );

    var sliderHandlerConfiguration = {};
    ...
    // For right sliders
    var rightSliderElement = createSliderElement();
    ...
    var leftPosition = ( ( this.effectivityRange.start - 1 ) * 20 );
    this.leftSliderHandler.setPosition( leftPosition );

    var rightPosition = ( ( this.effectivityRange.end ) * 20 );
    this.rightSliderHandler.setPosition( rightPosition );

};

var createSliderElement = function() {
    var sliderSvg = createSliderSVGElement( 10, 60 );
    var topOuterCircleSvg = createOuterCircleSVGElement( 4, 4, 4 );
    var topInnerCircleSvg = createInnerCircleSVGElement( 4, 4, 3 );
    var rectSvg = createRectSVGElement( 3.5, 1, 60 );
    var bottomOuterCircleSvg = createOuterCircleSVGElement( 4, 56, 4 );
    var bottomInnerCircleSvg = createInnerCircleSVGElement( 4, 56, 3 );
...
var createSliderSVGElement = function( width, height ) {
    var sliderSvg = document.createElementNS( svgns, 'svg' );
...
var createCircleSVGElement = function( cx, cy, r ) {
...
var createOuterCircleSVGElement = function( cx, cy, r ) {
    var circleSvg = createCircleSVGElement( cx, cy, r );
    circleSvg.setAttributeNS( null, 'class', 'aw-epValidateEffectivity-wiEffectivitySliderCircleOuter' );
    return circleSvg;
};

var createInnerCircleSVGElement = function( cx, cy, r ) {
    var circleSvg = createCircleSVGElement( cx, cy, r );
    circleSvg.setAttributeNS( null, 'class', 'aw-epValidateEffectivity-wiEffectivitySliderCircleInner' );
    return circleSvg;
};

var createRectSVGElement = function( x, width, height ) {
    var rectSvg = document.createElementNS( svgns, 'rect' );
...
EffectivitySlider.prototype.getSliderRange = function() {
    var end = this.rightSliderHandler.unit;
