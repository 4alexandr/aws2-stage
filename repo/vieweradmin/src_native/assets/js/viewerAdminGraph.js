...
export let clearGraph = function( data ) {
    awGraphService.clearGraph( data.graphModel );
};
 ...
 *
 * @member viewerAdminGraph
 * @memberof NgServices
 * @param  {Service} viewerAdminHealth health service
 * @param  {Service} svgTextUtils svg Text Utils
 * @param  {Service} awGraphService graph service
 * @returns {Object} exports object
 */
app.factory( 'viewerAdminGraph', () => exports );
