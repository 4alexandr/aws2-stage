...
export let getAllHealthObjects = function() {
    return appCtxService.ctx.viewerAdmin.allHealthObjects;
};
...
var _createHealthObject = function( type ) {
    ...
    appCtxService.ctx.viewerAdmin.allHealthObjects.push( obj );
...
export let parseHealthData = function( data ) {
    if( !data || !appCtxService.ctx.viewerAdmin.viewerHealth ) {
        logger.error( 'viewerAdminHealth: Data insufficient to parse health' );
    }

    var health = appCtxService.ctx.viewerAdmin.viewerHealth;
    ...
    appCtxService.ctx.viewerAdmin.isViewerHealthParsed = true;
 ...
 *
 * @member viewerAdminHealth
 * @memberof NgServices
 */
app.factory( 'viewerAdminHealth', () => exports );
