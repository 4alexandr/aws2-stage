 ...
 */
 ...
 export default class AC0InsertImage extends CKEDITOR5.Plugin {
    static get requires() {
        return [ InsertImageEditing, InsertImageUI ];
    }
}

class InsertImageUI extends CKEDITOR5.Plugin {
    init() {
...
class InsertImageEditing extends CKEDITOR5.Plugin {
    static get requires() {
...
class InsertImageCommand extends CKEDITOR5.Command {
    execute() {
        const editor = this.editor;
        ...
        input.addEventListener( 'change', function() {
            ...
            if ( file ) {
                ...
                var eventData = {
                    ...
                    eventBus.publish( 'ac0activeCollaboration.InsertImageInCKEditor',
                                    eventData );
            }
         }, false );
    ...
    destroy() {
        super.destroy();
        eventBus.unsubscribe( 'ac0activeCollaboration.InsertImageInCKEditor' );
    }
}
