...
export let mrmToggleChildOccurences = function( graphModel, node, contextKey, data, dataCtxNode ) {
    if( graphModel && node && node.getItemType() === 'Node' ) {
        ...
        if( !isExpanded && children.length === 0 ) {
            ...
            var listLoadInput = awTableSvc.createListLoadInput( null, resourceGraphDP.startIndex, null, true, false, dataCtxNode.filterStr );
 ...
 */
app.factory( 'MrmToggleChildOccsCommandHandler', () => exports );
