...
export let initLegendData = function( ctx, data ) {
    if( data.legendData ) {
        ...
        data.reInitializedLegendData = false;
        ...
        {
            // resource data is not loaded yet, need to reinitialized legend data once resource data is loaded.
            data.reInitializedLegendData = true;
        }
    }
};
...
/**
 * MrmResourceGraphLegendService factory
 */
...
app.factory( 'MrmResourceGraphLegendService', () => exports );
