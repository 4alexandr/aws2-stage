 ...
 * @param {ISOAResponse} response - GetOccurrences() SOA Response
 */
export let populateRequestPrefInfoOnOccmgmtContext = function( viewModeLoadResult, response ) {
...
export let populateFeaturesInfoOnOccmgmtContext = function( viewModeLoadResult, response, contextKey ) {
    var supportedFeatureList = occmgmtStateHandler.getSupportedFeaturesFromPCI( response.rootProductContext );
    var childPanelId = '';    
...
/**
 * @memberof NgServices
 * @member MrmOccmgmtGetOccsResponseService
 */
app.factory( 'MrmOccmgmtGetOccsResponseService', () => exports );
