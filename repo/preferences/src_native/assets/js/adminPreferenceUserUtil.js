 ...
 *
 * @memberof NgServices
 * @member adminPreferenceUserUtil
 *
 * @param {Object} soaService soa service functions
 * @param {Object} cdmService admin pref user util functions
 * @param {Object} dmService app ctx service functions
 * @param {Object} $q functions
 *
 * @returns {Object} export functions
 */
app.factory( 'adminPreferenceUserUtil', () => exports );
