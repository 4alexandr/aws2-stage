...
export let populateDeleteProductAreaPanel = function( data ) {
    ...
    data.productAreaList.unshift( emptyProductArea );
};
 ...
 * @memberof NgServices
 * @member deleteProductAreaService
 * @param {*} prefService - preference service
 * @param {*} adminPreferenceUserUtil - admin preference user util service
 * @param {*} soaService - soa service
 * @param {*} cmdPanelService - cmdPanelService
 *
 * @returns {*} exports
 */
app.factory( 'deleteProductAreaService', () => exports );
