...
/**
 * Service Proxy class
 * @module js/epGraphicsServiceProxy
 */
...
class EpGraphicsServiceProxy {
    constructor() {
         ...
         * App service URL
         */
        this.appServiceUrl = browserUtils.getBaseURL() + 'micro/ep-app/v1/';
    }
...
export default new EpGraphicsServiceProxy();
