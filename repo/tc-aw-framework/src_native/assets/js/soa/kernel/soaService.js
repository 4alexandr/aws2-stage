...
/**
 * @param {Number} pollingTimeout - timeout to allow polling SOA calls to be made after last non-polling call
 */
 ...
 *          data is available.
 */
export const post = function( serviceName, operationName, body, propertyPolicyOverride ) {
    return exports.request( serviceName, operationName, body, {
        propertyPolicyOverride: propertyPolicyOverride,
