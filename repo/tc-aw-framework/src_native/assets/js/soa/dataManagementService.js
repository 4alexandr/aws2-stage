 ...
 *          data is available.
 */
export let getTCSessionInfo = function() {
 ...
 *          data is available.
 */
export let saveEditAndSubmitToWorkflow = function( inputs ) {
    return soaSvc.post( 'Internal-AWS2-2016-12-DataManagement', 'saveEditAndSubmitToWorkflow', {
        inputs: inputs
    } );
};
 ...
 *          data is available.
 */
export let getStyleSheet2 = function( modelObject, styleSheetType, clientContext ) {
    var styleSheetTypeFinal = styleSheetType;
    var clientContextFinal = clientContext;
    ...
    return soaSvc.post( 'Internal-AWS2-2016-03-DataManagement', 'getStyleSheet2', {
        processEntireXRT: false,
        input: [ {
            businessObject: modelObject,
            styleSheetType: styleSheetTypeFinal,
 ...
 *          data is available.
 */
export let loadViewModelForEditing = function( inputs ) {
    return soaSvc.postUnchecked( 'Internal-AWS2-2017-06-DataManagement', 'loadViewModelForEditing', {
        inputs: inputs
    } );
};
