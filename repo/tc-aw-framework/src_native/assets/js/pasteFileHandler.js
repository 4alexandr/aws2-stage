...
/* global define FormData afxDynamicImport */
        ...
        _getDatasetTypes( targetObject, filenames ).then(
            ...
            if( errors.length > 0 ) {
                ...
                if( errors.length === 1 && errors[ 0 ].code === ERROR_CODE_CONSTRAINED_RELATION ) {
                    ...
                    throw exports.createError( createDatasetsAndRelateResponse.ServiceData );
                }
            }
...
/**
 * @memberof NgServices
 * @member pasteFileHandler
 */
app.factory( 'pasteFileHandler', () => exports );
