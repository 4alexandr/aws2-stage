 ...
 * @private
 *
 * @property {soa_kernel_soaService} CCached reference to the injected AngularJS service.
 */
...
export let getHistory = function() {
    ...
    var soaInput = {
        ...
        searchInput: {
            ...
            searchCriteria: {
                search: '',
                showConfiguredRev: awConfServ.getShowConfiguredRev()
            },
            startIndex: 0
        }
    };
...
/**
 * @memberof NgServices
 * @member soa_historyService
 */
app.factory( 'soa_historyService', () => exports );
