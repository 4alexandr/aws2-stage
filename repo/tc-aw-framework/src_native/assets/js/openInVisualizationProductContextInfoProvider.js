...
/**
 * This service allows Vis dependant modules to set 'productContext'
 *
 * @member openInVisualizationProductContextInfoProvider
 * @memberof NgServices
 *
 * @return {openInVisualizationProductContextInfoProvider} service exports.
 */
app.factory( 'openInVisualizationProductContextInfoProvider', () => exports );
