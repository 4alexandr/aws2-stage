...
let SPLMTableInfiniteScroll = function( containerHeight ) {
    ...
    let extraVisibleRowCount = browserUtils.isIE ? 20 : 5;
    ...
    /**
     * Remove extra rows
     * @param {Boolean} isScrollDown If scrolling down or not
     */
    function removeExtraRows( isScrollDown ) {
        ...
        if( rowElements.length === 0 ) {
            ...
            if( isScrollDown === true ) {
                ...
                var lastVisibleRowIndex = calculateLastVisibleRowIndex();
                if( settings.treeTableEditSettings ) {
