 ...
 */
export let startViewerMeasurement = function( viewerContextNamespace, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getMeasurementManager().startViewerMeasurement();
    deferred.resolve();
};
 ...
 * @return {Promise} A promise resolved once viewer measurement mode has started
 */
export let setMeasurementPickMode = function( viewerContextNamespace, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getMeasurementManager().setMeasurementPickMode();
    deferred.resolve();
};
 ...
 * @return {Promise} A promise resolved once viewer measurement mode has started
 */
export let startViewerQuery = function( viewerContextNamespace, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getMeasurementManager().startViewerQuery();
    deferred.resolve();
};
 ...
 * @return {Promise} A promise resolved once viewer measurement mode has started
 */
export let closeViewerQuery = function( viewerContextNamespace, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getMeasurementManager().closeViewerMeasurement();
    deferred.resolve();
};
 ...
 * @return {Promise} A promise resolved once viewer measurement mode has started
 */
export let setQueryPickMode = function( viewerContextNamespace, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getMeasurementManager().setQueryPickMode();
    deferred.resolve();
};
 ...
 * @return {Promise} A promise resolved once viewer measurement mode has started
 */
export let deleteSelectedQuery = function( viewerContextNamespace, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getMeasurementManager().deleteSelectedQuery();
    deferred.resolve();
};
 ...
 * @return {Promise} A promise resolved once viewer measurement mode has started
 */
export let deleteAllQueries = function( viewerContextNamespace, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getMeasurementManager().deleteAllQueries();
    deferred.resolve();
};
 ...
 *
 * @class viewerSecondaryModelInteractionService
 * @memberOf NgServices
 */
app.factory( 'viewerSecondaryModelInteractionService', () => exports );
