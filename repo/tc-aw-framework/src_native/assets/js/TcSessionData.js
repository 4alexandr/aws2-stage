...
function _logSessionData( appCtxSvc, soaResponse ) {
    if( soaResponse.analyticsData && soaResponse.analyticsData.isDataCollectionEnabled ) {
        ...
        var promise1 = analyticsSvc.setPreInitData( preInitData );
        promise1.then(
 ...
 * @param {typeDisplayNameService} TypeDisplayNameService.instance - Service to use.
 ...
 */
app.factory( 'TcSessionData', () => exports );
