 ...
 * @private
 *
 * @property {soa_dataManagementService} Cached reference to the injected AngularJS service.
 */
...
export let copyUrlToClipboard = function( selObject ) {
    ...
    return _copyContentToOSClipboard( content );
};
 ...
 * @return {Boolean} verdict whether the content was successfully copied to the clipboard or not
 */
var _copyContentToOSClipboard = function( content ) {
...
/**
 * The 'soa_clipboardService' manages a collection of IModelObjects that have been placed in the browser's
 * 'local storage'.
 *
 * @memberof NgServices
 * @member soa_clipboardService
 */
app.factory( 'soa_clipboardService', () => exports );
