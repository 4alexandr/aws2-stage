...
export let getCurrentDisplayRule = function( data ) {
    var displayRuleObj = cdm.getObject( data.eventData.property ? data.eventData.property.dbValue.uid : data.eventData.selectedObjects[ 0 ].uid );
    return displayRuleObj;
};
...
/**
 * This service update the IdDisplayRules list as required
 *
 * @memberof NgServices
 * @member idDisplayRuleMgmntUtils
 * @param {Object} localeSvc - Locale service to get locale value for empty display rule.
 * @param {Object} tcViewModelObjectSvc - VMO service.
 * @param {Object} cdm - client Data model service.
 * @param {Object} appCtxSvc - application context service.
 * @returns {Object} exports.
 */
app.factory( 'idDisplayRuleMgmntUtils', () => exports );
