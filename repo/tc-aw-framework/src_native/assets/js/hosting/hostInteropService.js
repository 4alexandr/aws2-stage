...
/**
 * {AngularJScopeObject} A 'child' $scope object of the AwRootScopeService.instance used to communicate information to
 * hosting-related services and commands.
 */
var _hostingScope;
...
function _processMessageCb( msgObj ) {
    ...
    switch ( msgObj.bioFunction ) {
        ...
        case 'splmInterop_HostServiceListUpdate':
            return splmInterop_HostServiceListUpdate( payloadObj.action, payloadObj.jsonList );
 ...
 * @memberof hostInteropService
 *
 * @returns {AngularJScopeObject} A $scope object 'child' of the AwRootScopeService.instance used to communicate information
 * to hosting-related services and commands.
 */
export let getHostingScope = function() {
    if( !_hostingScope ) {
        _hostingScope = AwRootScopeService.instance.$new();
    }
...
app.factory( 'hostInteropService', () => exports );
