 ...
 * Register service.
 *
 * @member hostWorkflowComponent_2015_03
 * @memberof NgServices
 *
 * @param {hostFactoryService} hostFactorySvc - Service to use.
 * @param {appCtxService} appCtxSvc - Service to use.
 * @param {dataManagementService} dms - Service to use.
 * @param {clientDataModel} cdm - Service to use.
 *
 * @returns {hostWorkflowComponent_2015_03} Reference to service's API object.
 */
app.factory( 'hostWorkflowComponent_2015_03', () => exports );
