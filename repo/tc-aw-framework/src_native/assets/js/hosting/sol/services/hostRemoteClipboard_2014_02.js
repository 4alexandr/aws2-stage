 ...
 * Register service.
 *
 * @member hostRemoteClipboard_2014_02
 * @memberof NgServices
 *
 * @param {hostFactoryService} hostFactorySvc - Service to use.
 * @param {hostObjectRefService} hostObjectRefSvc - Service to use.
 * @param {clipboardService} ClipboardService.instance - Service to use.
 * @param {soa_dataManagementService} dms - Service to use.
 * @param {soa_kernel_clientDataModel} cdm - Service to use.
 *
 * @returns {hostRemoteClipboard_2014_02} Reference to service's API object.
 */
app.factory( 'hostRemoteClipboard_2014_02', () => exports );
