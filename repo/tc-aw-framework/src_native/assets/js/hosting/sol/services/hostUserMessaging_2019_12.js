 ...
 * Register service.
 *
 * @member hostUserMessaging_2019_12
 * @memberof NgServices
 *
 * @param {hostFactoryService} hostFactorySvc - Service to use.
 * @param {notyService} notySvc - Service to use.
 * @param {fireCommandProxy} fireCommandProxy - Service to use.
 *
 * @returns {hostUserMessaging_2019_12} Reference to service's API object.
 */
app.factory( 'hostUserMessaging_2019_12', () => exports );
