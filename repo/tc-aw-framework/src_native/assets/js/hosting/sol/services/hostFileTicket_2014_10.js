 ...
 * @param {soa_fileManagementService} fms - Service to use.
 * @param {messagingService} messagingSvc - Service to use.
 *
 * @returns {hostFileTicket_2014_10} Reference to service's API object.
 */
app.factory( 'hostFileTicket_2014_10', () => exports );
