 ...
 */
function _processMessage( jsonData ) {
 ...
 */
export let getQueryHandler = function( queryId ) {
    ...
    if( handlerInfo ) {
        ...
        var factorSvc = AwInjectorService.instance.get( handlerInfo.service );
 ...
 * Register service.
 *
 * @member hostQuery_2015_10
 * @memberof NgServices
 */
app.factory( 'hostQuery_2015_10', () => exports );
