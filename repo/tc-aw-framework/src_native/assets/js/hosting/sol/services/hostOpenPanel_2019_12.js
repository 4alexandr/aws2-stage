...
import 'js/hosting/hostBaseRefService';
 ...
 * Register service.
 *
 * @member hostOpenPanel_2019_12
 * @memberof NgServices
 *
 * @param {hostFactoryService} hostFactorySvc - Service to use.
 * @param {commandPanelService} commmandPanelSvc - Service to use.
 *
 * @returns {hostOpenPanel_2019_12} Reference to service's API object.
 */
app.factory( 'hostOpenPanel_2019_12', () => exports );
