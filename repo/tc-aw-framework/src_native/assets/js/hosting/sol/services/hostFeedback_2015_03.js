 ...
 * Register service.
 *
 * @member hostFeedback_2015_03
 * @memberof NgServices
 *
 * @param {AwStateService.instance} AwStateService.instance - Service to use.
 * @param {AwRootScopeService.instance} AwRootScopeService.instance - Service to use.
 * @param {hostFactoryService} hostFactorySvc - Service to use.
 * @param {hostSelection_2014_02} hostSelection1 - Service to use.
 *
 * @returns {hostFeedback_2015_03} Reference to service's API object.
 */
app.factory( 'hostFeedback_2015_03', () => exports );
