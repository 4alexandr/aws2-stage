 ...
 * @param {String} clientUrl - Client URL
 */
var ClientInfoMsg = function( clientFullVersionIdentifier, clientVersionNumber, clientBuildLabel, clientUrl ) {
 ...
 * Register service.
 *
 * @member hostClientInfo_2014_07
 * @memberof NgServices
 *
 * @param {hostFactoryService} hostFactorySvc - Service to use.
 *
 * @returns {hostClientInfo_2014_07} Reference to service's API object.
 */
app.factory( 'hostClientInfo_2014_07', () => exports );
