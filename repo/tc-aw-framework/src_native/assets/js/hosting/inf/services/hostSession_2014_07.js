...
function _doSetUserSessionStates( states ) {
    return sessionService.setUserSessionState( states );
}
        ...
        dms.loadObjects( uids ).then( function() {
            dms.getProperties( uids, [ 'object_string' ] ).then( function() {
                ...
                if( revRuleObj2 ) {
                    ...
                    commandSvc.executeCommand( 'HostingSetRevisionRule', null, hostingScope );
                }
            } );
        } );
    }
 ...
 * Register service.
 *
 * @member hostSession_2014_07
 * @memberof NgServices
 */
app.factory( 'hostSession_2014_07', () => exports );
