...
export let openNewShowObjectViewInHost = function( modelObjs ) {
     ...
     */
    _.forEach( modelObjs, function( modelObj ) {
        var urlParameter = urlPrefix + '#com.siemens.splm.clientfx.tcui.xrt.showObject;uid=' + modelObj.uid;
 ...
 * Register service.
 *
 * @member hostOpenService
 * @memberof NgServices
 *
 * @param {hostInteropService} hostInteropSvc - Service to use.
 * @param {hostBaseRefService} hostBaseRefSvc - Service to use.
 * @param {hostObjectRefService} hostObjectRefSvc - Service to use.
 * @param {hostOpen_2014_02} hostOpenSvc1 - Service to use.
 * @param {hostOpen_2015_03} hostOpenSvc2 - Service to use.
 * @param {hostOpen_2015_10} hostOpenSvc3 - Service to use.
 * @param {hostOpenNewView_2016_04} hostOpenNewViewSvc - Service to use.
 *
 * @returns {hostOpenService} Reference to service's API object.
 */
app.factory( 'hostOpenService', () => exports );
