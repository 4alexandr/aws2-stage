...
IsQuerySupportedQueryHandler.prototype.handleQuery = function( inputMessage ) {
    ...
    if( !_.isEmpty( dataObjects ) ) {
        ...
        if( queryId ) {
            var isHandled = Boolean( exports.getQueryHandler( queryId ) );
...
export let areAnyObjectsSupported = function( commandId, modelObjects ) {
    ...
    var supportedResults = _areObjectsSupported( commandId, modelObjects );
 ...
 * Register service.
 *
 * @member hostQueryService
 * @memberof NgServices
 */
app.factory( 'hostQueryService', () => exports );
