 ...
 */
function _getValidContextObject() {
    var obj;
...
ContextInteropObjectEncoder.prototype.isObjectSupported = function( object ) {
    return cmm.isInstanceOf( 'Dataset', object.modelType ) && _getValidContextObject();
};
...
ContextInteropObjectTypeFactory.prototype.createInteropObjectRef = function( modelObject, objEncoder ) {
    ...
    var obj = _getValidContextObject();
 ...
 *
 * @returns {hostObjectRef_2014_10} Reference to this service's API object.
 */
app.factory( 'hostObjectRef_2014_10', () => exports );
