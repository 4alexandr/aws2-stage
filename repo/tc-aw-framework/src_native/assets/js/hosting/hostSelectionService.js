...
/**
 * This service handles sending selections from the 'client' to the 'host' in the most 'modern way' the 'host' can
 * support it. The processing attempts to avoid sending 'echos' of previous (recent) selections from the 'host' back
 * to the 'host'.
 *
 * @member hostSelectionService
 * @memberof NgServices
 */
app.factory( 'hostSelectionService', () => exports );
