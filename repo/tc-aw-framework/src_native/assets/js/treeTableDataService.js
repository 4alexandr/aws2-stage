 ...
 */
export let loadTreeTablePropertiesOnInitialLoad = function( vmNodes, declViewModel, uwDataProvider, context, contextKey, updateColumnPropsCallback ) {
    ...
    if( uwDataProvider && !uwDataProvider.columnConfig.columnConfigId ) {
        ...
        return tcVmoService.getTableViewModelProperties( allChildNodes, propertyLoadContextLcl ).then( function( response ) {
            if( response && !declViewModel.isDestroyed() ) {
                ...
                uwDataProvider.columnConfig = columnConfigResult;
...
export let loadTreeTableProperties = function() {
    ...
    return _loadProperties( propertyLoadInput, propLoadCtxt, contextKey, declViewModel, uwDataProvider, updateColumnPropsCallback );
};
 ...
 */
function _loadProperties( propertyLoadInput, propertyLoadContext, contextKey, declViewModel, uwDataProvider, updateColumnPropsCallback ) {
...
/**
 * @memberof NgServices
 * @member treeTableDataService
 */
app.factory( 'treeTableDataService', () => exports );
