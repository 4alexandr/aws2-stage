 ...
 * @param {Promise} deferred - promise from calling function to be resolved. Will be removed in future
 */
export let executeSelectedOffCommand = function( viewerContextNamespace, allSelectedCSIDS, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
 ...
 * @param {Promise} deferred - promise from calling function to be resolved. Will be removed in future
 */
export let executeSelectedOnCommand = function( viewerContextNamespace, allSelectedCSIDS, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
 ...
 * @param {Promise} deferred - promise from calling function to be resolved. Will be removed in future
 */
export let executeSelectedOnlyCommand = function( viewerContextNamespace, allSelectedCSIDS, deferred ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
...
export let executeRemoveAnalysisResultCommand = function( viewerContextNamespace ) {
    var viewerCtx = _viewerCtxSvc.getRegisteredViewerContext( viewerContextNamespace );
    viewerCtx.getVisibilityManager().removeAnalysisResult();
};
 ...
 * @memberOf NgServices
 */
app.factory( 'viewerInteractionService', () => exports );
