...
export let hookOutline = function( frameContentWindow, frameContentDoc ) {
    frameContentWindow.DocumentOutlineView = function documentOutlineView( outline ) {
        ...
        function bindItemLink( domObj, item ) {
            ...
            if( frameContentWindow && frameContentWindow.pdfjsLib && typeof frameContentWindow.pdfjsLib.aw_getDestinationHash === 'function' ) {
                try {
                    domObj.href = frameContentWindow.pdfjsLib.aw_getDestinationHash( item.dest );
                } catch ( err ) {
            ...
            domObj.onclick = function documentOutlineViewOnclick( e ) {
                if( frameContentWindow && frameContentWindow.pdfjsLib && typeof frameContentWindow.pdfjsLib.aw_navigateTo === 'function' ) {
                    try {
                        frameContentWindow.pdfjsLib.aw_navigateTo( item.dest );
                    } catch ( err ) {
...
export function rotateCW() {
    try {
        frameContentWindowLocal.pdfjsLib.aw_rotatecw();
    } catch ( err ) {
...
export function rotateCCW() {
    try {
        frameContentWindowLocal.pdfjsLib.aw_rotateccw();
    } catch ( err ) {
