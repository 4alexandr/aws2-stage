 ...
 *          data is available.
 */
export let getTableViewModelProperties = function getTableViewModelProperties( vmNodes, context ) {
    var missingUids = [];
    ...
    if( missingUids.length > 0 ) {
        return soaSvc.post( 'Internal-AWS2-2017-12-DataManagement', 'getTableViewModelProperties', input )
            .then( function( response ) {
                // process DCPs
 ...
 *
 * @memberof NgServices
 * @member tcViewModelObjectService
 *
 ...
 *
 * @return {tcViewModelObjectService} Reference to service API.
 */
app.factory( 'tcViewModelObjectService', () => exports );
