...
export let convertToAnotherUnitsFromMeter = function( input, inputUnit ) {
    ...
    if( _.isString( inputUnit ) ) {
        ...
        for( var key in _unitMap ) {
            if( _unitMap[ key ] === inputUnit ) {
                inputUnitString = key;
                break;
            }
        }
...
/**
 * Set of unit conversion functions for viewer
 *
 * @member viewerUnitConversionService
 * @memberof NgServices
 *
 */
app.factory( 'viewerUnitConversionService', () => exports );
