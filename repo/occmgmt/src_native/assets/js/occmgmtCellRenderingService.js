 ...
 * @param {Object} columnDef - Column definition on which cell template is needed.
 * @returns {String} - Cell template string.
 */
var getCellTemplate = function( columnDef ) {
...
export let setOccmgmtCellTemplate = function( columnDefs, cellRenderers ) {
    for( var index = 0; index < columnDefs.length; index++ ) {
        var column = columnDefs[ index ];
        column.cellTemplate = getCellTemplate( column );
