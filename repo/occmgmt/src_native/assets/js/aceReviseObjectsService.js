...
var postActionOnPwaReset = function() {
...
var refreshGivenView = function( viewKey ) {
    ...
    appCtxService.updatePartialCtx( viewKey + '.postProcessingFuncOnInitializeAction', postActionOnPwaReset );
...
app.factory( 'aceReviseObjectsService', () => exports );
