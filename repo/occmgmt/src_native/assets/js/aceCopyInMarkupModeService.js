...
function isMarkupObject( obj ) {
    return obj.modelType.typeHierarchyArray.indexOf( 'Awb0MarkupElement' ) > -1 ||
        ( '128' === _.get( obj, 'props.awb0MarkupType.dbValues[0]' ) );
}
...
_localeTextBundle = localeSvc.getLoadedText( app.getBaseUrlPath() + '/i18n/OccurrenceManagementConstants' );
export default exports = {
    execute
};
app.factory( 'aceCopyInMarkupModeService', () => exports );
