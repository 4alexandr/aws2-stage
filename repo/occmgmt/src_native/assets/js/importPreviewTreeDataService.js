 ...
 * @param {*} treeLoadInput 
 */
function getSoaInput( treeLoadInput )
{
    let fmsTicket;
    let propInfos = [];
    let typeMapInfos = {};
...
export let loadTreeTableData = function( treeLoadInput, dataProvider, declViewModel, cursor ) {
    ...
    let soaInput = getSoaInput( treeLoadInput );
    ...
    if( propertyLoadInput ) {
        ...
        _.forEach( propertyLoadInput.propertyLoadRequests, function( propertyLoadRequest ) {
            _.forEach( propertyLoadRequest.childNodes, function( childNode ) {
                ...
                _populateColumns( propertyLoadRequest.columnInfos, childNode, childNode.childNdx + 1 );
...
app.factory( 'importPreviewTreeDataService', () => exports );