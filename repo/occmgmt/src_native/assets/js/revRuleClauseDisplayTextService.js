...
function getOverrideDisplayText( isForAddClause ) {
    ...
    if( ctx.RevisionRuleAdmin[ folder_type ] ) {
        folder = ctx.RevisionRuleAdmin[ folder_type ].props.object_name.dbValue;
    }
 ...
 *
 */
function getDateDisplayText( data, isForAddClause ) {
 ...
 *
 */
export let getDisplayTextForClause = function( data, entryType, isForAddClause ) {
    var displayText = undefined;
    switch ( entryType ) {
        case 0:
        ...
        case 2:
            ...
            break;
        case 3:
            displayText = getDateDisplayText( data, isForAddClause );
            break;
        case 4:
 ...
 */
app.factory( 'revRuleClauseDisplayTextService', () => exports );
