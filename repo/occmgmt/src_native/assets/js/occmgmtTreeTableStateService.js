...
export let setupCacheToRestoreExpansionStateOnConfigChange = function( uwDataProvider, declViewModel,
    pciBeforeConfigurationChange, currentContext, pciToExpandedNodesStableIdsMap ) {
    var pciAfterConfigurationChange = currentContext.currentState.pci_uid;
    var allNodesInCache = uwDataProvider.viewModelCollection.getLoadedViewModelObjects();
...
/**
 * @memberof NgServices
 * @member occmgmtTreeTableStateService
 */
app.factory( 'occmgmtTreeTableStateService', () => exports );
