...
export let updateCtxWithStaleUids = function( responsePref, childOccurrences, parentChildrenInfos ) {
    ...
    appCtxSvc.updatePartialCtx( 'aceActiveContext.context.staleIndexedLineUids', staleUidsEncountered );
};
...
app.factory( 'aceStaleRowMarkerService', () => exports );
