 ...
 * 
 * @module js/showRemoveProjectCellCommandHandlerLegacy
 */
import app from 'app';
...
export let removeProjects = function( data ) {
    AssignProjectsServiceLegacy.addToAvailableProjects( data, _assignProjects );
};
 ...
 */
app.factory( 'showRemoveProjectCellCommandHandlerLegacy', () => exports );
