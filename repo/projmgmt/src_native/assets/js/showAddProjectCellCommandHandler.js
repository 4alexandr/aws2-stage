 ...
 * 
 * @module js/showAddProjectCellCommandHandler
 */
import app from 'app';
...
export let addProjects = function( data ) {
    AssignProjectsService.addToMemberOfProjects( data, _assignProjects );
 ...
 */
app.factory( 'showAddProjectCellCommandHandler', () => exports );
