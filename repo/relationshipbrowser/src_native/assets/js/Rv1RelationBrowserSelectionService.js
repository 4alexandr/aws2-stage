    ...
    try {
        ...
        if( selectedElements && selectedElements.length > 1 ) {
            _.each( selectedElements, function( selectedElement ) {
                selectectObjectsList.push( selectedElement.appData.nodeObject );
            } );
        }
        ...
        if( selectectObjectsList.length > 1 ) {
            selectionService.updateSelection( selectectObjectsList, parent );
        }
    } catch ( ex ) {
        logger.debug( ex );
    }
...
/** -------------------------------------------------------------------
 * Rv1RelationBrowserSelectionService factory
 */
...
app.factory( 'Rv1RelationBrowserSelectionService', () => exports );
