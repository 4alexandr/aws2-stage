...
export let pageUp = function() {
    if( pageCallback ) {
        pageCallback( 'up' );
    }
};

export let pageDown = function() {
    if( pageCallback ) {
        pageCallback( 'down' );
    }
};

export let pan2D = function() {
    var awTwoDViewerNavMode = appCtxSvc.getCtx( 'awTwoDViewerNavMode' );
    awTwoDViewerNavMode = 'pan';
    appCtxSvc.updateCtx( 'awTwoDViewerNavMode', awTwoDViewerNavMode );
...
export let zoom2D = function() {
    var awTwoDViewerNavMode = appCtxSvc.getCtx( 'awTwoDViewerNavMode' );
    awTwoDViewerNavMode = 'zoom';
    appCtxSvc.updateCtx( 'awTwoDViewerNavMode', awTwoDViewerNavMode );
...
export let setCurrentPage = function( numPage ) {
    if( _setCurrentPageCallback ) {
        return setCurrentPageCallback( numPage );
    }
};
...
if( !awTwoDViewerNavMode ) {
    appCtxSvc.updateCtx( 'awTwoDViewerNavMode', 'pan' );
}
 ...
 *
 * @memberof NgServices
 * @member utils2dViewer
 */
app.factory( 'utils2dViewer', () => exports );
