...
//Constant for essential columns for Program view
export let SCH_GANTT_ESSENTIAL_COLUMNS = [ 'uid', 'duration', 'complete_percent', 'work_estimate', 'work_complete', 'start_date', 'finish_date', 'task_type', 'fnd0status', 'ResourceAssignment', 'fnd0WhatIfMode', 'fnd0WhatIfData' ];
 ...
 *
 * @memberof NgServices
 * @member ScheduleManagerConstants
 */
app.factory( 'ScheduleManagerConstants', () => exports );
