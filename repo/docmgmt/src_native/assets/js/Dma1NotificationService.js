        ...
        dmSvc.getProperties( [ message.uid ], [ 'fnd0MessageBody' ] ).then( function( response ) {
            ...
            if( message.props.fnd0MessageBody !== null && message.props.fnd0MessageBody.dbValues !== null &&
                ...
                if( messageBody.startsWith( "ItemRevDerDsRelName:" ) ) {
                    ...
                    var objName = "";
                    if( targetObject.props !== null && targetObject.props.object_name !== null &&
                        targetObject.props.object_name.uiValues !== null && targetObject.props.object_name.uiValues.length > 0 ) {
                        objName = targetObject.props.object_name.uiValues[ 0 ];
                    }

                    appCtxService.ctx.docmgmtfloat_name = objName;
...
app.factory( 'Dma1NotificationService', () => exports );
