...
/**
 * @module js/aw-action-summary.controller
 */
import app from 'app';
...
/**
 * The controller for the aw-action-summary directive
 *
 * @class awActionSummaryController
 * @memberof NgControllers
 */
app.controller( 'awActionSummaryController', [
    '$scope',
    '$q',
    'panelContentService',
    'viewModelService',
    function( $scope, $q, panelContentSvc, viewModelSvc ) {
        ...
        self.loadCommandDefSummary = function() {
            ...
            if( selection ) {
                return panelContentSvc.getPanelContent( 'actionBuilderGraph' ).then( function( response ) {
                    ...
                    return viewModelSvc.populateViewModelPropertiesFromJson( response.viewModel ).then( function( declViewModel ) {
                        if( $scope.selection.uid === selection.uid ) {
                            //Update view
                        ...
                        return $q.reject( 'Data changed while loading Action Summary' );
                    } );
                } );
            }
