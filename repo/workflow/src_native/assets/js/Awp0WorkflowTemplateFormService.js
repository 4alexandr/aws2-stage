 ...
 */
export let populateFormTableData = function( data, selection, dataProvider ) {
    parentData = data;
    var argumentRows = [];
 ...
 * @param {Array} dynamicParticipants Dynamic participants array that will contain internal name and display name
 */
export let reloadPanel = function( selection ) {
    ...
    exports.populateFormTableData( parentData, templateObject, parentData.dataProviders.formDataProvider );
};
 ...
 */
export let updateFormHandlerContext = function( handlerObject, dataProvider ) {
...
/**
 * Check when user is selecting any row in form gabdler table and Add or show panel is open then close the panel
 * @param {Object} ctx Context object
 */
export let formHandlerRowSelection = function( ctx ) {
    if( ctx.activeToolsAndInfoCommand && ( ctx.activeToolsAndInfoCommand.commandId === 'Awp0WorkflowAddFormHandler'
...
export default exports = {
    ...
    reloadPanel,
    updateFormHandlerContext,
    formHandlerRowSelection,
    getRemoveFormHandlerObjects
};
/**
 * Define form handler service
 *
 * @memberof NgServices
 * @member Awp0WorkflowTemplateFormService
 */
app.factory( 'Awp0WorkflowTemplateFormService', () => exports );
