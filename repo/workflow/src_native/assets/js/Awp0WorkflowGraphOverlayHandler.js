...
var getNodeStyle = function( nodeObject, node, isGroup, graphModel ) {
    ...
    var style = null;
    style = templateService.getNodeTemplate( graphModel.nodeTemplates, cellPropNames, isGroup );
    return style;
};
...
export let setOverlayNode = function( graphModel, node, pointOnPage ) {
    if( graphModel && graphModel.graphControl ) {
        ...
        var overlayNodeStyle = getNodeStyle( node.appData.nodeObject, node, isGroup, graphModel );
 ...
 *
 * @memberof NgServices
 * @member Awp0WorkflowGraphOverlayHandler
 */
app.factory( 'Awp0WorkflowGraphOverlayHandler', () => exports );
