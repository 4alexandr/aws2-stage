...
export default class PlaceholderUI extends CKEDITOR5.Plugin {
    init() {
        ...
        resizePromise = setTimeout( function() {
            ...
            if ( showRequirementQualityData && changes ) {
                var contectEle = changes.position;
                        if ( contectEle && contectEle.parent ) {
                            ...
                            var selectedReq = editor.selectedRequirement;
        ...
        editor.on( 'updateQualityMatrix', function( eventData, selection, domElement, isNewRequirement, targetElement ) {
            ...
            if ( showRequirementQualityData ) {
                ...
                editor.selectedRequirement = selection;
...
function findAndSavePath( instances, editor, metricIdArray ) {
    ...
    var selectedRequirement = editor.newSelectedRequirement ? editor.newSelectedRequirement : editor.selectedRequirement;
