...
export default class RMSplitRequirement extends CKEDITOR5.Plugin {
    init() {
...
function subscribeEventToEnableSplitCommand( editor ) {
    eventToEnableSplitCommand =  eventBus.subscribe( 'ckeditor.clickedInsideBodyText', function( ) {
