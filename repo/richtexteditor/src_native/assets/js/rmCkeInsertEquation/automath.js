...
export default class AutoMath extends CKEDITOR5.Plugin {
    static get requires() {
        return [ CKEDITOR5.Clipboard, CKEDITOR5.Undo ];
    }
    ...
    init() {
        ...
        this.listenTo( editor.plugins.get( CKEDITOR5.Clipboard ), 'inputTransformation', () => {
            const firstRange = modelDocument.selection.getFirstRange();

            const leftLivePosition = CKEDITOR5.LivePosition.fromPosition( firstRange.start );
            leftLivePosition.stickiness = 'toPrevious';

            const rightLivePosition = CKEDITOR5.LivePosition.fromPosition( firstRange.end );
    ...
    _mathBetweenPositions( leftPosition, rightPosition ) {
        ...
        const equationRange = new CKEDITOR5.LiveRange( leftPosition, rightPosition );
        ...
        this._positionToInsert = CKEDITOR5.LivePosition.fromPosition( leftPosition );
