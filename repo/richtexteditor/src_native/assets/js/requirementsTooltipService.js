...
var _getTracelinkedItem = function( linkInfo, linkIcon, data ) {
    ...
    var item = {
        ...
        removeTracelinkedObjectTitle: data && data.i18n && data.i18n.Remove ? data.i18n.Remove : '',
 ...
 */
export let getTooltipContentData = function( data, ctx ) {
    data.showMoreTracelinkOption = _showMoreTracelinkOption;
    var sourceObj = cdm.getObject( _selectedTooltipObject.uid );
    if( !sourceObj ) {
        sourceObj = _selectedTooltipObject;
    }
    data.selectedTooltipObject = sourceObj;
    ctx.Arm0TraceLinkTooltipBalloonPopupVisible = true;

    return _tracelinkedItems;
};
...
export let closeExistingTracelinkTooltip = function( ctx, noHoverCheck ) {
    if( ctx.Arm0TraceLinkTooltipBalloonPopupVisible && ctx.Arm0TraceLinkTooltipBalloonPopupVisible === true ) {
        ...
        ctx.Arm0TraceLinkTooltipBalloonPopupVisible = false;
 ...
 *
 * @memberof NgServices
 * @member requirementsTooltipService
 */
app.factory( 'requirementsTooltipService', () => exports );
