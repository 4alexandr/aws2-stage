...
export let showHtmlCompareReport = function( htmlData, data ) {
    ...
    if ( divs && divs.length > 0 ) {
        ...
        showHistoryLabel( fileNames[0], fileNames[1], data );
        var requirementDiv = document.createElement( 'div' );

        //Adding CSS
        requirementDiv.innerHTML = compareUtils.addCssInContents( htmlData );
 ...
 */
export let constructLoadingText = function( loadingText, selectedObjects ) {
    var fileName1 = '';
    var fileName2 = '';
    ...
    appCtxSvc.registerCtx( 'Arm0RequirementCompareTextLoadMessage', loadMsg );
...
export let latestReqSpecifications = function( data, selectedObjectsInOrder ) {
    ...
    if ( response.revToFullText ) {
        ...
        appCtxSvc.registerCtx( 'Arm0RequirementCompareTextLoadMessage', data.i18n.Arm0EmptyReqSpecCompareError );
    }
};
...
/**
 * This is Compare Text for Requirement revision.
 *
 * @memberof NgServices
 * @member Arm0MultiSelectCompareText
 */
app.factory( 'Arm0MultiSelectCompareText', () => exports );
