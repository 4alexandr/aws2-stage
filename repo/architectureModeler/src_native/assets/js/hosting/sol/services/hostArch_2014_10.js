...
ArchSelectionTypeHandler.prototype.processObjects = function( objects, parser, selectionTime ) { // eslint-disable-line no-unused-vars
    ...
    if( !occMgmtCtx || !appCtxSvc.ctx.graph || !appCtxSvc.ctx.architectureCtx ) {
        return;
    }
 ...
 *
 * @returns {hostArch_2014_10} Reference to this service's API object.
 */
app.factory( 'hostArch_2014_10', () => exports );
