 ...
 */
export let applyGraphLayout = function( graphModel, isKeepPosition, isRecallCase, isApplyGlobalLayout ) {
    ...
    if( architectureCtx && architectureCtx.diagram &&
        architectureCtx.diagram.isAutoLayoutOn === false ) {
        if( !isRecallCase ) {
...
app.factory( 'Ase0ArchitectureLayoutService', () => exports );
