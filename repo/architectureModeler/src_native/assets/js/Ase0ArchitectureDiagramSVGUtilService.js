...
var XMLNS_VALUE = 'http://www.w3.org/2000/svg';
var XMLNS_KEY = 'xmlns';
var ATTR_ID = 'id';
...
var setXMLNSForUse = function( elements ) {
    _.forEach( elements, function( element ) {
        if( !element.getAttribute( USE_XLINK_ATTRIBUTE_KEY ) ) {
            element.setAttribute( USE_XLINK_ATTRIBUTE_KEY, USE_XLINK_ATTRIBUTE_VAL );
        }
    } );
};
...
app.factory( 'Ase0ArchitectureDiagramSVGUtilService', () => exports );
