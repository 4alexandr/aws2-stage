...
var getProductContextOrRootElementUids = function() {
    var uidProductContexts = '';
    var uidRootElements = '';
    var uids = [];
    var occmgmtContext = appCtxSvc.getCtx( 'aceActiveContext.context' );
 ...
 */
export let setViewerVisibility = function( selections, action, viewerContext ) {
    ...
    var rootElementUids = getProductContextOrRootElementUids();
...
app.factory( 'Ase0VisSelectionService', () => exports );
