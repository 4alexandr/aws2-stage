 ...
 * @param {object} eventData - event data about the element created on graph
 */
export let nodeCreatedCompletionAction = function( data, graphDataResponse, eventData ) {
    ...
    try {
        ...
        if( nodesObjectInfo ) {
            ...
            utilSvc.checkWhetherToSelectObjectInAce( nodesObjectInfo[ 0 ].node.props.awb0Parent.dbValues[ 0 ],
                nodesObjectInfo[ 0 ].node.uid, false );
        }
...
app.factory( 'Ase0ArchitectureNodeCreateService', () => exports );
