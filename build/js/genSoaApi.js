...
module.exports.generate = function( cb ) {
    ...
    gulp.src( [
            ...
            `${dirname( require.resolve( 'angular' ) )}/angular.min.js`
        ] )
        .pipe( chmod( 0o777 ) )
        .pipe( gulp.dest( module.exports._localVars.outDir ) )
        .on( 'error', logger.pipeErrorHandler )
        .on( 'end', createStructure );
};
...
function generateStructure() {
    ...
    util.writeFile( module.exports._localVars.outDir + '/structure.js', 'const data = \n' + JSON.stringify( module.exports._localVars.structuredJson ) ).then( () => {
        module.exports._localVars.cb();
    } );
}
...
function createStructure() {
    gulp.src( [ module.exports._localVars.srcDir + '/json/*_template.json',
